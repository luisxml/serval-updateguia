...
*!*					oFSO.DeleteFolder("D:\SFS_v1.2_SUPERVAN\sunat_archivos\sfs\RPTA\dummy",.t.) 
                   
                cMiZip 	  =   taFiles(lnFileCount)
				cDirDesti = '\\'+Vpc_server+'\SFS_v1.2_SUPERVAN\sunat_archivos\sfs\RPTA\'
...
*!*	                oFSO = CREATEOBJECT("Scripting.FileSystemObject") 
*!*					oFSO.DeleteFolder('\\'+Vpc_server+'\SFS_v1.2_SUPERVAN\sunat_archivos\sfs\RPTA\dummy',.t.) 
				
				Vlc_dir = DIRECTORY('\\'+Vpc_server+'\SFS_v1.2_SUPERVAN\sunat_archivos\sfs\RPTA\dummy')
